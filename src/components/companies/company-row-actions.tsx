...
export function CompanyRowActions({ companyId, companyName }: Props) {
        ...
        >
          <div className="bg-card border border-border rounded-2xl shadow-xl w-full max-w-sm p-6" dir="rtl">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              هل أنت متأكد من حذف الشركة <span className="font-semibold text-foreground">«{companyName}»</span>؟
            </p>
